...
def read_all() -> pd.DataFrame:
    data_path = os.path.join('/nfs/project/xuyixiao', 'data.hd')
...
def run():
    ...
    parser.add_argument('--add_timestamp', default=63, type=int, help="Add N timestamp in a future for prediction")
    parser.add_argument('--start', default=0, type=int, help="Effective start date. Data before the start is dropped")
    parser.add_argument('--end', default=-63, type=int, help="Effective end date. Data past the end is dropped")
